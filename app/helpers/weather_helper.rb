module WeatherHelper
  # 天気の大まかな分類
  FAIR_CONDITIONS = ["Clear", "Clouds"].freeze
  INCLEMENT_CONDITIONS = ["Rain", "Drizzle", "Thunderstorm", "Snow", "Squall", "Tornado", "Mist", "Haze", "Fog"].freeze
  OTHERS_CONDITIONS = ["Smoke", "Dust", "Sand", "Ash"].freeze
